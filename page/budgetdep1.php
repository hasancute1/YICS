...
<!-- end sidebar back -->   
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title font-size-26 font-weight-600">Budget Body Plant 1  Overview (x Million)</h1>
      </div>
        ...
        <div class="col-lg-5 col-md-5">
          ...
          <div class="col-lg-4 col-md-6 info-panel">
            <div class="card card-shadow" style="border-radius: 15px;height:200px;">
              <div class="card-block bg-yellow-800 p-20" style="border-radius: 15px;height:200px;">
              ...
              <div class="row">
                <div class="col-lg-6 col-md-7 py-20 ">
                  <div class="text-left">
                    ...
                    <div class="pie-progress " data-plugin="pieProgress" data-barcolor="#FFE54F"
