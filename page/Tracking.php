                                        ...
                                        <div class="card-header card-header-transparent">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="panel-heading">
                                                        <h4 class=" text-left"><?= $data_ia['ia'] ?></h4>
                                                        <hr style="border-color:grey;">
                                                        <h5 class=" text-left">Procurement NB For Support Production
                                                        </h5>
                                                        <hr style="border-color:grey;">
                                                    </div>
                                                </div>
                ...
                ?>
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="pearls row">
                                                        <div
                                                            ...
                                                            <br>
                                                            <div
                                                                class="list-group bg-blue-grey-100 bg-inherit text-left w-250 ml-5">
                              ...
                              $tracking = get_item_trac_ia($tracking_ia_rss , $row['id_prog']);                                                          
                                ?>
                                                                ...
                                                                <div
                                                                    class="list-group-item bg-<?= ($status? "teal":"gray") ?>-300">
                                                                    ...
                                                                    <i class="icon wb-user"
                                                                        aria-hidden="true"></i><?=($status)?'By Effendy':'-'?>
                                                                </div>
                                                                <?php } ?>
                                ...
                                ?>
                                                                <div
                                                                    class="list-group-item bg-<?= (in_array($row['id_prog'] , $id_prog_bp)? "teal":"gray") ?>-300">
                                                                    <?=($status)? '<i class="icon wb-check" aria-hidden="true"></i>':''?>
                                                                    <?= $row['nama_progress'] ?><br>
                                                                    <i class="icon oi-calendar" aria-hidden="true"></i>
                                                                    <?=($status)?$tracking['time'] . ' WIB':'-'?>
                              ...
                              ?>
                                                                <div
                                                                    class="list-group-item bg-<?= (in_array($row['id_prog'] , $id_prog_pr)? "teal":"gray") ?>-300">
                                                                    <?=($status)? '<i class="icon wb-check" aria-hidden="true"></i>':''?>
                                                                    <?= $row['nama_progress'] ?><br>
                                                                    <i class="icon oi-calendar" aria-hidden="true"></i>
                                                                    <?=($status)?$tracking['time'] . ' WIB':'-'?>
                                ...
                                ?>
                                                                <div
                                                                    class="list-group-item bg-<?= (in_array($row['id_prog'] , $id_prog_gr)? "teal":"gray") ?>-300">
                                                                    <?=($status)? '<i class="icon wb-check" aria-hidden="true"></i>':''?>
                                                                    <?= $row['nama_progress'] ?><br>
                                                                    <i class="icon oi-calendar" aria-hidden="true"></i>
                                                                    <?=($status)?$tracking['time'] . ' WIB':'-'?>
