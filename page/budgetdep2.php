                ...
                <div><br><br>
                    ...
                    <div class="page">
                        <div class="page-header">
                            <h1 class="page-title font-size-26 font-weight-600">Budget Body Plant 2 Overview (x Million)
                            </h1>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="card card-shadow" style="border-radius: 15px;height:200px;">
                                                <div class="card-block bg-red-800 p-20"
                                                    ...
                                                    <div class="col-lg-6 col-md-7 py-20 ">
                                                        <div class="text-left">
                                                            ...
                                                            <div class="pie-progress " data-plugin="pieProgress"
                                                                data-barcolor="#E62020" data-size="100" data-barsize="8"
                                                ...
                                                <div class="float-right">
                                                    <i href="" data-toggle="tooltip" data-original-title="Tambah Data">
                                                        <button type="button"
                                                            ...
                                                            data-toggle="modal" data-target="#TambahPlaningProposal">
                                        ...
                                        <table width="100%" class="table-striped">
                                            <thead class="text-center">
                                                <tr class="bg-info align-" height="10px">
                                                    <th class="align-middle text-center" height="10px" rowspan="2">N0
                                                    </th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">
                                                        CATEGORY</th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">NO.
                                                        IA</th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">
                                                        DESCRIPTION</th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">
                                                        BENEFIT</th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">DATE
                                                    </th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">TOTAL
                                                        TRANSC</th>
                                                    <th class="align-middle text-center" height="10px" rowspan="2">
                                                        STATUS</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr class="text-wrap">
                                                    ...
                                                    <td class="align-middle text-center">P4/BDY/IP/07/21/I.4 .04.C-00005
                                                    </td>
