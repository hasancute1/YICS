...
<!-- end sidebar back -->   
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title font-size-26 font-weight-600">Budget BQC  Overview (x Million)</h1>
      </div>
        ...
        <div class="col-lg-5 col-md-5">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-shadow" style="border-radius: 15px;height:200px;">
              <div class="card-block bg-purple-800 p-20" style="border-radius: 15px;height:200px;">
                <button type="button" class="btn btn-floating btn-sm btn-success">
                  <i class="icon fa-dollar"></i>
                </button>
                <span class="white font-weight-400 font-size-20">BQC</span>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-7 py-20 ">
                  <div class="text-left">
                    ...
                    <div class="pie-progress " data-plugin="pieProgress" data-barcolor="#7231F5"
          ...
          <div class="col-lg-12 col-md-12" id="ecommerceRecentOrder">
            <div class="card card-shadow">
              ...
              <canvas id="myBar6" height="46" width="100%"></canvas>
...
<script>
  var ctx = document.getElementById("myBar6").getContext('2d');
		var myBar6 = new Chart(ctx, {
			type: 'bar',
			data: {
				...
				datasets: [
                  ...
                  {
                    label: "CONSUMTION BQC",
                    backgroundColor: Config.colors("purple", 200),
