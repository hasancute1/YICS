                        ...
                        <form action="" method="GET" class="row">
                            ...
                            <div class="form-group">
                               <div class="input-group">
                                  <input style="background-color:#E4EAEC;" type="text" class="form-control" name="cari" placeholder="Search..." value="<?=$cari?>">
                                   <span class="input-group-append">
                                       <button type="submit" class="btn btn-primary" ><i class="icon wb-search" aria-hidden="true"></i></button>
                                       <a href="fiscalsetting.php" class="btn btn-danger">Reset</a>
                                   </span>
                                </div>
                             </div>
                             </div>
                        </form>                
                          <form id="wadahtabel" class="table table-bordered text-nowrap" name="proses" > 
                            <table class=" w-full"> 
                              <thead class="text-center">
                                <tr class="bg-info align-" height="10px">
                                  <th class="align-middle text-center" height="10px">NO</th>
                                  <th class="align-middle text-center" height="10px">PERIODE</th>
                                  <th class="align-middle text-center" height="10px">START FISCAL</th>
                                  <th class="align-middle text-center" height="10px">END FISCAL</th>
                                  <th class="align-middle text-center" height="10px">STATUS</th>
                                  <th class="align-middle text-center" height="10px">ACTION</th>                        
                                  <th class="align-middle text-center" height="10px"><input type="checkbox" id="checkAll"></th>                        
                                </tr >
                              </thead>
                              <tbody>
                              <?php 
                                      ...
                                      if(mysqli_num_rows($sql)>0){
                                        ...
                                        while($data = mysqli_fetch_array($sql_data)){?>
                                          <tr>
                                            ...
                                            <td class="align-middle text-center text-uppercase"><?php echo $data['periode']; ?></td>
                                            <td class="align-middle text-center text-uppercase " ><?php echo date("d M Y", strtotime($data['awal'])); ?></td> 
                                            <td class="align-middle text-center text-uppercase" ><?php echo date("d M Y", strtotime($data['akhir'])); ?></td>
                                            <td class="align-middle text-center text-uppercase"><?php echo $data['status']; ?></td>
                                            <td class="align-middle text-center" >
                                              <i href="" data-toggle="tooltip" data-original-title="Edit">
                                                <a href="formubahfiscalsetting.php?ubah=<?php echo $data['id_fis']; ?>" class="btn btn-success btn-icon btn-outline btn-xs" >
                                                  <i class="icon wb-edit" aria-hidden="true"></i>
                                                </a>
                                              </i>
                                              <i href="javascript:void(0)" data-toggle="tooltip" data-original-title="Hapus">
                                                <a href="../proses/usersetting/timefiscal.php?del=<?php echo $data['id_fis']; ?>" class="btn btn-icon btn-danger btn-icon btn-outline btn-xs HapusData">
                                                    <i class="icon oi-trashcan" aria-hidden="true"></i>
                                                  </a>
                                              </i> 
                                            </td>
                                            <td class="align-middle text-center" height="10px"><input name="check[]" value="<?php echo $data['id_fis']; ?>" type="checkbox" class="check"></td>
                                          </tr>
                                          <?php
                                ...
                                <div class="row">
                                   <div class="col-lg-8">
                                      <ul class="pagination">
                                            ...
                                            ?>
                                              <li class="page-item"><a class="page-link" href="fiscalsetting.php?page=1">First</a></li>
                                              <li class="page-item"><a class="page-link" href="fiscalsetting.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                                            <?php
                                            }
                                            ?>
                                            ...
                                            ?>
                                              <li<?php echo $link_active; ?>><a class="page-link" href="fiscalsetting.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                            <?php
                                            }
                                            ?>
                                            ...
                                            ?>
                                              <li class="page-item"><a class="page-link" href="fiscalsetting.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                                              <li class="page-item"><a class="page-link" href="fiscalsetting.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                                            <?php
                                            }
                                            ?>
                                      </ul>
                                  ...
                                  <div class="col-md-4 col-lg-4 text-right">
                                      <button class="btn btn-md btn-danger HapusAll" style="border-radius: 10px;"><i class="icon fa-trash"></i>Hapus data</button>
                                  </div> 
                            </div>                      
                        </div>  
                      </div>
                              ...
                              <div class="modal-dialog modal-simple modal-center ">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body" >
                                      <form action="../proses/usersetting/timefiscal.php" method="POST"  class="needs-validation">
                                        ...
                                        <div class="form-group row">
                                              ...
                                              <div class="col-md-8">
                                                <input type="date" class="form-control" name="akhir" placeholder="Silahkan isi end fiscal" autocomplete="off" required >
                                              </div>
                                        </div>
                                        <div class="form-group row">
