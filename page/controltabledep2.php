...
<!-- end sidebar back -->   
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title font-size-26 font-weight-600">Control Table Body Plant 2 (x Million)</h1>
      </div>
                              ...
                              <div class="modal-dialog modal-simple modal-center modal-lg">
                                <div class="modal-content">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                        <input type="text" class="form-control  bg-grey-200" name="name" placeholder="Division Yourself" autocomplete="off" value="Body Plant 2">
                                          </div>
                                        </div>
                                      <label class="col-md-2 col-form-label text-left" style="color:black;">Category</label>
                                      <div class="col-md-4">
