    ...
    <footer class="site-footer">
        <div class="site-footer-legal">© 2022 All Right Reserved</div>
        <div class="site-footer-right">
            Crafted with <i class="red-600 wb wb-heart"></i> by Team Digitalization In Body Division - PT ADM</a>
        </div>
    </footer>
    <!-- endFooter -->
    <!-- Core  -->
...
Config.set('assets', '../base/assets');
    ...
    <!-- <script src="datadonutmoris/example.js"></script> -->
    <!-- data table -->
    <!-- <script src="../global/js/Plugin/datatables.js"></script>
    <script src="../base/assets/examples/js/tables/datatable.js"></script> -->
...
$(document).ready(function() {
    ...
    } else if (notifikasi == "Dihapus" || notifikasi == "Diubah") {
    ...
    } else if (notifikasi == "Kosong" || notifikasi == "Gagal Diubah") {
        Swal.fire({
            icon: 'error',
            title: 'GAGAL',
            text: '' + pesan
