(function (global, factory) {
    ...
    (function () {
      ...
      (0, _jquery.default)('.HapusData').on("click", function () {
        swal({
          title: "Apakah Sahabat yakin?",
          text: "Sahabat tidak dapat mengembalikan data ini !",
          type: "warning",
          ...
          swal("Deleted!", "Data sahabat sudah dihapus!", "success");
        });
      });
