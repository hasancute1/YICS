...
--
-- Host: localhost
-- Generation Time: Oct 18, 2022 at 05:16 PM
...
--
-- Table structure for table `kategori_proposal`
--
...
--
-- Dumping data for table `kategori_proposal`
--
...
--
-- Table structure for table `keterangan_progress`
--
...
--
-- Dumping data for table `keterangan_progress`
--
...
--
-- Table structure for table `konversi_matauang`
--
...
--
-- Dumping data for table `konversi_matauang`
--

INSERT INTO `konversi_matauang` (`id_matauang`, `rupiah`) VALUES
('dollar', 15000),
('yen', 105);
...
INSERT INTO `proposal` (`id_prop`, `username`, `id_dep`, `id_kat`, `proposal`, `cost`, `id_fis`) VALUES
(43, '1234', 1, 2, 'proposal 1', 20000, 17),
(44, '1234', 1, 1, 'proposal 2', 20000, 17),
(45, '', 1, 1, 'tes 2', 2000, 17),
(46, '', 1, 1, 'proposal hasan', 2, 17),
(48, '1234', 1, 1, 'PEMBELIAN MEJA LIPAT2', 10, 17);
...
--
-- Table structure for table `time_fiscal`
--
...
--
-- Dumping data for table `time_fiscal`
--
...
--
-- Table structure for table `tracking_ia`
--
...
--
-- Dumping data for table `tracking_ia`
--
...
--
-- Table structure for table `tracking_prop`
--
...
--
-- Dumping data for table `tracking_prop`
--
...
--
-- Stand-in structure for view `view_alokasi_budget`
...
--
-- Structure for view `view_alokasi_budget`
--
...
--
-- Indexes for table `kategori_proposal`
--
ALTER TABLE `kategori_proposal`
  ADD PRIMARY KEY (`id_kat`);

--
-- Indexes for table `keterangan_progress`
--
ALTER TABLE `keterangan_progress`
  ADD PRIMARY KEY (`id_ket`);

--
-- Indexes for table `konversi_matauang`
--
...
--
-- AUTO_INCREMENT for table `kategori_proposal`
--
ALTER TABLE `kategori_proposal`
  MODIFY `id_kat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `keterangan_progress`
--
ALTER TABLE `keterangan_progress`
...
--
ALTER TABLE `proposal`
  MODIFY `id_prop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
-- AUTO_INCREMENT for table `time_fiscal`
--
ALTER TABLE `time_fiscal`
  MODIFY `id_fis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tracking_ia`
--
ALTER TABLE `tracking_ia`
  MODIFY `id_trackia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tracking_prop`
--
ALTER TABLE `tracking_prop`
  MODIFY `id_trackprop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
