...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Jan 2023 pada 05.03
...
('35639', 'efendi', 7, '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 2),
('37932', 'HASAN', 6, 'bea8ed4d790d7df42ab78ad2ae59c6e7ba1e893b', 2),
('44131', 'RIO SETIAWAN JUDEEN', 9, '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 1);
...
(1, '44131', '37932', 'proposal', 19, 'Pending', 'Telah Ditambahkan', '2023-01-17 03:47:00');
...
--
ALTER TABLE `area`
  MODIFY `id_area` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `budget`
--
ALTER TABLE `budget`
  MODIFY `id_bud` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `ia`
  MODIFY `id_ia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `plan_proposal`
  MODIFY `id_prop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `proposal`
  MODIFY `id_prop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `tracking_prop`
  MODIFY `id_trackprop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
