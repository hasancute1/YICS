...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Okt 2022 pada 15.46
...
(43, 1, 2, 'proposal 1', 20000, 17),
(44, 1, 1, 'proposal 2', 20000, 17),
...
--
ALTER TABLE `proposal`
  MODIFY `id_prop` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
